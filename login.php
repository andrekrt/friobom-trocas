...
if(isset($_POST['login']) && isset($_POST['senha'])){
    ...
    $sql = $db->prepare("SELECT * FROM usuario WHERE (cpf = :cpf OR email = :cpf) AND senha = :senha");
    ...
    if($sql->rowCount()>0){
        ...
        $_SESSION['tipoUsuario'] = $dado['tipo_usuario_idtipo_usuario'];
        $_SESSION['nomeUsuario'] = $dado['nome_usuario'];
...
<html lang="pt-br">
    <head>
        ...
        <title>FRIOBOM - SOLICITAÇÕES DE TROCAS</title>
