...
if(isset($_SESSION['idUsuario']) && empty($_SESSION['idUsuario'])==false){
    ...
    foreach($trocas as $troca){
        ...
        if($consulta->rowCount()===0){
           ...
           $sql = $db->query("INSERT INTO troca (pedido, cod_cliente, fantasia, razao_social, data_troca, cod_rca, nome_rca, cod_sup, nome_sup, valor_atend, fornecedor, situacao, posicao) VALUES ('$troca[NUMPED]', '$troca[CODCLI]' , '$troca[FANTASIA]', '$troca[CLIENTE]', '$dataTroca', '$troca[CODUSUR]', '$troca[NOMERCA]', '$troca[CODSUPERVISOR]', '$troca[NOMESUP]', '$valor', '$fornecedor[CODFORNEC]', 'aguardando', '$troca[POSICAO]') ");  
